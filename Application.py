...
local_alignment_mx = Project.compute_alignment_matrix(seq_human, seq_fly, scoring_matrix, False)
result = Project.compute_local_alignment(seq_human, seq_fly, scoring_matrix, local_alignment_mx)
...
global_alignment_mx_human = Project.compute_alignment_matrix(ali_human, seq_con, scoring_matrix, True) 
global_alignment_mx_fly = Project.compute_alignment_matrix(ali_fly, seq_con, scoring_matrix, True)

result2_human = Project.compute_global_alignment(ali_human, seq_con, scoring_matrix, global_alignment_mx_human)
result2_fly = Project.compute_global_alignment(ali_fly, seq_con, scoring_matrix, global_alignment_mx_fly)
...
Question 3
"""
scoring_distribution = Project.generate_null_distribution(seq_human, seq_fly, scoring_matrix, 1000)
...
print Project.check_spelling('humble', 1, word_list)
print
print Project.check_spelling('firefly', 2, word_list)
